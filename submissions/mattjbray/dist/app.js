...
var _staltz$flux_challenge$Main$aLast = function (arr) {
	return A2(
		_elm_lang$core$Array$get,
		_elm_lang$core$Array$length(arr) - 1,
		arr);
};
var _staltz$flux_challenge$Main$aFirst = _elm_lang$core$Array$get(0);
var _staltz$flux_challenge$Main_ops = _staltz$flux_challenge$Main_ops || {};
_staltz$flux_challenge$Main_ops['>>='] = F2(
	function (_p0, f) {
		var _p1 = _p0;
		var _p2 = f(_p1._0);
		var model$ = _p2._0;
...
var _staltz$flux_challenge$Main$bindAll = F2(
	function (modelEffects, fs) {
		return A3(
			_elm_lang$core$List$foldl,
			_elm_lang$core$Basics$flip(
				F2(
					function (x, y) {
						return A2(_staltz$flux_challenge$Main_ops['>>='], x, y);
					})),
			modelEffects,
			fs);
	});
var _staltz$flux_challenge$Main$pure = function (model) {
	return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
};
var _staltz$flux_challenge$Main$andThenAndThen = F2(
	function (mmValue, f) {
		return A2(
			_elm_lang$core$Maybe$andThen,
			mmValue,
			A2(_elm_lang$core$Basics$flip, _elm_lang$core$Maybe$andThen, f));
	});
var _staltz$flux_challenge$Main$mMap2 = F3(
	function (func, ma, mb) {
...
var _staltz$flux_challenge$Main$any = F2(
	function (pred, array) {
		return _elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$Array$length(
				A2(_elm_lang$core$Array$filter, pred, array)),
			0) > 0;
	});
var _staltz$flux_challenge$Main$notNothing = function (maybe) {
	var _p4 = maybe;
	if (_p4.ctor === 'Nothing') {
		return false;
	} else {
...
var _staltz$flux_challenge$Main$isNothing = function (_p5) {
	return _elm_lang$core$Basics$not(
		_staltz$flux_challenge$Main$notNothing(_p5));
};
var _staltz$flux_challenge$Main$inBounds = F2(
	function (pos, slots) {
		return (_elm_lang$core$Native_Utils.cmp(pos, 0) > -1) && (_elm_lang$core$Native_Utils.cmp(
			pos,
			_elm_lang$core$Array$length(slots)) < 0);
	});
var _staltz$flux_challenge$Main$viewPlanetMonitor = function (mWorld) {
	return A2(
			...
			[
				...
				A2(
					...
					function () {
						var _p6 = mWorld;
						if (_p6.ctor === 'Just') {
							return A2(_elm_lang$core$Basics_ops['++'], 'on ', _p6._0.name);
						} else {
							return 'in transit';
						}
					}()))
...
var _staltz$flux_challenge$Main$onWorld = F2(
	function (mJedi, mWorld) {
		var _p7 = A3(
			_staltz$flux_challenge$Main$mMap2,
			F2(
				function (v0, v1) {
					return {ctor: '_Tuple2', _0: v0, _1: v1};
				}),
			...
			mJedi);
		if (_p7.ctor === 'Just') {
			return _elm_lang$core$Native_Utils.eq(_p7._0._1.homeworld.id, _p7._0._0.id);
		} else {
			return false;
		}
	});
var _staltz$flux_challenge$Main$viewJedi = F2(
	function (mWorld, mJedi) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(_staltz$flux_challenge$Main$onWorld, mJedi, mWorld) ? _elm_lang$core$Native_List.fromArray(
						[
				...
				if (_p8.ctor === 'Nothing') {
					...
					return _elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text(_p9.homeworld.name)
								]))
						]);
				}
			}());
	});
var _staltz$flux_challenge$Main$canScroll = F3(
	function (upOrDown, scrollSpeed, model) {
		var scrollDisabled = A2(
			_staltz$flux_challenge$Main$any,
			A2(_elm_lang$core$Basics$flip, _staltz$flux_challenge$Main$onWorld, model.world),
			model.jediSlots);
		var _p10 = function () {
			var _p11 = upOrDown;
			if (_p11.ctor === 'Up') {
				return {
					ctor: '_Tuple4',
					_0: _staltz$flux_challenge$Main$aFirst,
					_1: function (_) {
						return _.master;
					},
					_2: 0,
				...
				return {
					ctor: '_Tuple4',
					_0: _staltz$flux_challenge$Main$aLast,
					_1: function (_) {
						return _.apprentice;
					},
					_2: scrollSpeed,
					_3: _elm_lang$core$Array$length(model.jediSlots)
				};
			}
		}();
		...
		var jediInView = A2(
			_staltz$flux_challenge$Main$any,
			_staltz$flux_challenge$Main$notNothing,
			A3(_elm_lang$core$Array$slice, scrollStart, scrollEnd, model.jediSlots));
		var loadedJedis = A2(_elm_lang$core$Array$filter, _staltz$flux_challenge$Main$notNothing, model.jediSlots);
		var next = A2(
			_staltz$flux_challenge$Main$andThenAndThen,
			getFirstOrLast(loadedJedis),
			apprenticeOrMaster);
		return _staltz$flux_challenge$Main$notNothing(next) && (jediInView && _elm_lang$core$Basics$not(scrollDisabled));
	});
var _staltz$flux_challenge$Main$haveJediAt = F2(
	function (pos, _p12) {
		var _p13 = _p12;
		return !_elm_lang$core$Native_Utils.eq(
			A2(_elm_lang$core$Array$get, pos, _p13.jediSlots),
			_elm_lang$core$Maybe$Just(_elm_lang$core$Maybe$Nothing));
	});
var _staltz$flux_challenge$Main$needJediAt = F2(
	function (pos, model) {
		return A2(_staltz$flux_challenge$Main$inBounds, pos, model.jediSlots) && _elm_lang$core$Basics$not(
			A2(_staltz$flux_challenge$Main$haveJediAt, pos, model));
	});
var _staltz$flux_challenge$Main$removeRequest = F2(
	function (request, requests) {
		return A2(
			_elm_lang$core$List$filter,
			function (r) {
				return !_elm_lang$core$Native_Utils.eq(r.id, request.id);
			},
			requests);
	});
var _staltz$flux_challenge$Main$adjustPos = F3(
	function (pos, oldScrollPos, newScrollPos) {
		var offset = oldScrollPos - newScrollPos;
		return pos + offset;
	});
var _staltz$flux_challenge$Main$abortAndSaveAllRequests = function (model) {
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Native_Utils.update(
			model,
			{
				jediRequests: _elm_lang$core$Native_List.fromArray(
					[]),
				requestsToResume: A2(_elm_lang$core$List$append, model.requestsToResume, model.jediRequests)
			}),
		_1: _elm_lang$core$Platform_Cmd$batch(
			A2(
				_elm_lang$core$List$map,
...
var _staltz$flux_challenge$Main$abortRequests = function (model) {
	var _p14 = A2(
		_elm_lang$core$List$partition,
		function (request) {
			return A2(
				_staltz$flux_challenge$Main$inBounds,
				A3(_staltz$flux_challenge$Main$adjustPos, request.insertPos, request.scrollPos, model.scrollPos),
				model.jediSlots);
		},
		model.jediRequests);
	...
	return {
		...
		_0: _elm_lang$core$Native_Utils.update(
			model,
			{jediRequests: newRequests}),
		_1: _elm_lang$core$Platform_Cmd$batch(aborts)
	};
};
var _staltz$flux_challenge$Main$initModel = F2(
	function (nbSlots, scrollSpeed) {
		return {
			world: _elm_lang$core$Maybe$Nothing,
			jediSlots: A2(_elm_lang$core$Array$repeat, nbSlots, _elm_lang$core$Maybe$Nothing),
			scrollPos: 0,
			scrollSpeed: scrollSpeed,
			jediRequests: _elm_lang$core$Native_List.fromArray(
				[]),
			requestsToResume: _elm_lang$core$Native_List.fromArray(
				[]),
			nextRequestId: 0
		};
	});
var _staltz$flux_challenge$Main$mkJediUrl = function (id) {
	return {
		id: id,
		url: A2(
			_elm_lang$core$Basics_ops['++'],
...
var _staltz$flux_challenge$Main$darthSidious = _staltz$flux_challenge$Main$mkJediUrl(3616);
var _staltz$flux_challenge$Main$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {world: a, jediSlots: b, scrollPos: c, scrollSpeed: d, jediRequests: e, requestsToResume: f, nextRequestId: g};
	});
var _staltz$flux_challenge$Main$World = F2(
	function (a, b) {
		return {id: a, name: b};
	});
var _staltz$flux_challenge$Main$decodeWorld = A3(
	_elm_lang$core$Json_Decode$object2,
	_staltz$flux_challenge$Main$World,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'name', _elm_lang$core$Json_Decode$string));
var _staltz$flux_challenge$Main$Jedi = F5(
	function (a, b, c, d, e) {
		return {id: a, name: b, homeworld: c, master: d, apprentice: e};
	});
var _staltz$flux_challenge$Main$JediUrl = F2(
	function (a, b) {
		return {id: a, url: b};
	});
var _staltz$flux_challenge$Main$decodeJediUrl = A2(
	...
	function (mId) {
		...
		if (_p15.ctor === 'Just') {
			return A2(
				...
				function (url) {
					return _elm_lang$core$Maybe$Just(
						A2(_staltz$flux_challenge$Main$JediUrl, _p15._0, url));
				},
...
var _staltz$flux_challenge$Main$decodeJedi = A6(
	_elm_lang$core$Json_Decode$object5,
	_staltz$flux_challenge$Main$Jedi,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'name', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'homeworld', _staltz$flux_challenge$Main$decodeWorld),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'master', _staltz$flux_challenge$Main$decodeJediUrl),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'apprentice', _staltz$flux_challenge$Main$decodeJediUrl));
var _staltz$flux_challenge$Main$JediRequest = F5(
	function (a, b, c, d, e) {
		return {id: a, jediUrl: b, insertPos: c, scrollPos: d, abort: e};
	});
var _staltz$flux_challenge$Main$Down = {ctor: 'Down'};
var _staltz$flux_challenge$Main$Up = {ctor: 'Up'};
var _staltz$flux_challenge$Main$NoAction = {ctor: 'NoAction'};
var _staltz$flux_challenge$Main$Scroll = F2(
	function (a, b) {
		return {ctor: 'Scroll', _0: a, _1: b};
	});
var _staltz$flux_challenge$Main$viewScrollButton = F2(
	function (model, dir) {
		var clickHandler = _elm_lang$html$Html_Events$onClick(
			A2(_staltz$flux_challenge$Main$Scroll, dir, model.scrollSpeed));
		var enabled = A3(_staltz$flux_challenge$Main$canScroll, dir, model.scrollSpeed, model);
...
var _staltz$flux_challenge$Main$viewScrollButtons = function (model) {
	var scrollDisabled = A2(
		_staltz$flux_challenge$Main$any,
		A2(_elm_lang$core$Basics$flip, _staltz$flux_challenge$Main$onWorld, model.world),
		model.jediSlots);
	return A2(
		...
		A2(
			_elm_lang$core$List$map,
			_staltz$flux_challenge$Main$viewScrollButton(model),
			_elm_lang$core$Native_List.fromArray(
				[_staltz$flux_challenge$Main$Up, _staltz$flux_challenge$Main$Down])));
};
var _staltz$flux_challenge$Main$viewJediList = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
					_elm_lang$core$List$map,
					_staltz$flux_challenge$Main$viewJedi(model.world),
					_elm_lang$core$Array$toList(model.jediSlots))),
				_staltz$flux_challenge$Main$viewScrollButtons(model)
			]));
};
var _staltz$flux_challenge$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_staltz$flux_challenge$Main$viewPlanetMonitor(model.world),
				_staltz$flux_challenge$Main$viewJediList(model)
			]));
};
var _staltz$flux_challenge$Main$SetJedi = F2(
	function (a, b) {
		return {ctor: 'SetJedi', _0: a, _1: b};
	});
var _staltz$flux_challenge$Main$fetchJedi = F4(
	function (sleepMillis, insertPos, jediUrl, model) {
		var abortEffect = _elm_lang$core$Platform_Cmd$none;
		var request = {id: model.nextRequestId, jediUrl: jediUrl, insertPos: insertPos, scrollPos: model.scrollPos, abort: abortEffect};
		var sendTask = A2(_evancz$elm_http$Http$get, _staltz$flux_challenge$Main$decodeJedi, jediUrl.url);
		var sendEffect = A3(
			_elm_lang$core$Task$perform,
			function (_p17) {
				return _staltz$flux_challenge$Main$NoAction;
			},
			_staltz$flux_challenge$Main$SetJedi(request),
			_elm_lang$core$Task$toResult(
				A2(
					_elm_lang$core$Task$andThen,
					_elm_lang$core$Process$sleep(sleepMillis),
					function (_p18) {
						return sendTask;
					})));
		return {
			...
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{
					jediRequests: A2(_elm_lang$core$List_ops['::'], request, model.jediRequests),
					nextRequestId: model.nextRequestId + 1
				}),
			_1: sendEffect
		};
	});
var _staltz$flux_challenge$Main$init = F3(
	function (nbSlots, scrollSpeed, jediUrl) {
		return A4(
			_staltz$flux_challenge$Main$fetchJedi,
			0,
			(nbSlots / 2) | 0,
			jediUrl,
			A2(_staltz$flux_challenge$Main$initModel, nbSlots, scrollSpeed));
	});
var _staltz$flux_challenge$Main$retryRequest = F3(
	function (sleepMillis, request, model) {
		var model$ = _elm_lang$core$Native_Utils.update(
			model,
			{
				jediRequests: A2(_staltz$flux_challenge$Main$removeRequest, request, model.jediRequests)
			});
		var newInsertPos = A3(_staltz$flux_challenge$Main$adjustPos, request.insertPos, request.scrollPos, model$.scrollPos);
		return A4(_staltz$flux_challenge$Main$fetchJedi, sleepMillis, newInsertPos, request.jediUrl, model$);
	});
var _staltz$flux_challenge$Main$resumeAllRequests = function (model) {
	var model$ = _elm_lang$core$Native_Utils.update(
		model,
		{
			requestsToResume: _elm_lang$core$Native_List.fromArray(
	...
	return A2(
		_staltz$flux_challenge$Main$bindAll,
		_staltz$flux_challenge$Main$pure(model$),
		A2(
			_elm_lang$core$List$map,
			_staltz$flux_challenge$Main$retryRequest(0),
			model.requestsToResume));
};
var _staltz$flux_challenge$Main$setWorld = F2(
	function (world, model) {
		var model$ = _elm_lang$core$Native_Utils.update(
			model,
			{
				world: _elm_lang$core$Maybe$Just(world)
			});
		return A2(
			_staltz$flux_challenge$Main$any,
			A2(
				_elm_lang$core$Basics$flip,
				_staltz$flux_challenge$Main$onWorld,
				_elm_lang$core$Maybe$Just(world)),
			model$.jediSlots) ? _staltz$flux_challenge$Main$abortAndSaveAllRequests(model$) : _staltz$flux_challenge$Main$resumeAllRequests(model$);
	});
var _staltz$flux_challenge$Main$maybeFetchJedi = F4(
	function (pos, nextPos, getNextUrl, model) {
		var mNext = A2(_staltz$flux_challenge$Main$needJediAt, nextPos, model) ? A2(
			_staltz$flux_challenge$Main$andThenAndThen,
			A2(_elm_lang$core$Array$get, pos, model.jediSlots),
			getNextUrl) : _elm_lang$core$Maybe$Nothing;
		var _p19 = mNext;
		if (_p19.ctor === 'Just') {
			return A4(_staltz$flux_challenge$Main$fetchJedi, 0, nextPos, _p19._0, model);
		} else {
			return _staltz$flux_challenge$Main$pure(model);
		}
	});
var _staltz$flux_challenge$Main$maybeFetchJedisAround = F2(
	function (pos, model) {
		return A2(
			_staltz$flux_challenge$Main_ops['>>='],
			A2(
				_staltz$flux_challenge$Main_ops['>>='],
				_staltz$flux_challenge$Main$pure(model),
				A3(
					_staltz$flux_challenge$Main$maybeFetchJedi,
					pos,
					pos - 1,
					function (_) {
						return _.master;
...
var _staltz$flux_challenge$Main$setJedi = F3(
	function (request, newJediResult, model) {
		var maybeRetry = function () {
			var _p20 = newJediResult;
			if (_p20.ctor === 'Err') {
				return A2(_staltz$flux_challenge$Main$retryRequest, 1000, request);
			} else {
				return _staltz$flux_challenge$Main$pure;
			}
		}();
		var adjustedPos = A3(_staltz$flux_challenge$Main$adjustPos, request.insertPos, request.scrollPos, model.scrollPos);
		var newMJedi = _elm_lang$core$Result$toMaybe(newJediResult);
		var newJediSlots = A2(_staltz$flux_challenge$Main$inBounds, adjustedPos, model.jediSlots) ? A3(_elm_lang$core$Array$set, adjustedPos, newMJedi, model.jediSlots) : model.jediSlots;
		var model$ = _elm_lang$core$Native_Utils.update(
			model,
			{
				jediRequests: A2(_staltz$flux_challenge$Main$removeRequest, request, model.jediRequests),
		...
		var maybeAbortAll = A2(_staltz$flux_challenge$Main$onWorld, newMJedi, model.world) ? _staltz$flux_challenge$Main$abortAndSaveAllRequests : _staltz$flux_challenge$Main$pure;
		return A2(
			_staltz$flux_challenge$Main_ops['>>='],
			A2(
				_staltz$flux_challenge$Main_ops['>>='],
				A2(_staltz$flux_challenge$Main$maybeFetchJedisAround, adjustedPos, model$),
				maybeRetry),
			maybeAbortAll);
	});
var _staltz$flux_challenge$Main$doScroll = F3(
	function (model, dir, scrollSpeed) {
		if (_elm_lang$core$Basics$not(
			A3(_staltz$flux_challenge$Main$canScroll, dir, scrollSpeed, model))) {
			return _staltz$flux_challenge$Main$pure(model);
		} else {
			var emptySlots = A2(_elm_lang$core$Array$repeat, scrollSpeed, _elm_lang$core$Maybe$Nothing);
			var slotsLength = _elm_lang$core$Array$length(model.jediSlots);
			var _p21 = function () {
				var _p22 = dir;
				if (_p22.ctor === 'Up') {
					return {
						...
						_0: A2(
							...
							emptySlots,
							A3(_elm_lang$core$Array$slice, 0, slotsLength - scrollSpeed, model.jediSlots)),
					...
					return {
						...
						_0: A2(
							_elm_lang$core$Array$append,
							A3(_elm_lang$core$Array$slice, scrollSpeed, slotsLength, model.jediSlots),
							emptySlots),
						_1: model.scrollPos + scrollSpeed,
			...
			var newJedis = _p21._0;
			var newScrollPos = _p21._1;
			var endJediPos = _p21._2;
			return A2(
				_staltz$flux_challenge$Main_ops['>>='],
				A2(
					_staltz$flux_challenge$Main_ops['>>='],
					_staltz$flux_challenge$Main$pure(
						_elm_lang$core$Native_Utils.update(
							model,
							{jediSlots: newJedis, scrollPos: newScrollPos})),
					_staltz$flux_challenge$Main$abortRequests),
				_staltz$flux_challenge$Main$maybeFetchJedisAround(endJediPos));
		}
	});
var _staltz$flux_challenge$Main$update = F2(
	function (action, model) {
		var _p23 = action;
		switch (_p23.ctor) {
			case 'SetJedi':
				return A3(_staltz$flux_challenge$Main$setJedi, _p23._0, _p23._1, model);
			case 'SetWorld':
				var _p24 = A2(_elm_lang$core$Json_Decode$decodeString, _staltz$flux_challenge$Main$decodeWorld, _p23._0);
				if (_p24.ctor === 'Err') {
					return _staltz$flux_challenge$Main$pure(model);
				} else {
					return A2(_staltz$flux_challenge$Main$setWorld, _p24._0, model);
				}
			case 'Scroll':
				return A3(_staltz$flux_challenge$Main$doScroll, model, _p23._0, _p23._1);
			default:
				return _staltz$flux_challenge$Main$pure(model);
		}
	});
var _staltz$flux_challenge$Main$SetWorld = function (a) {
	return {ctor: 'SetWorld', _0: a};
};
var _staltz$flux_challenge$Main$subscriptions = function (_p25) {
	return A2(_elm_lang$websocket$WebSocket$listen, 'ws://localhost:4000', _staltz$flux_challenge$Main$SetWorld);
};
var _staltz$flux_challenge$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: A3(_staltz$flux_challenge$Main$init, 5, 2, _staltz$flux_challenge$Main$darthSidious),
			update: _staltz$flux_challenge$Main$update,
			view: _staltz$flux_challenge$Main$view,
			subscriptions: _staltz$flux_challenge$Main$subscriptions
		})
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _staltz$flux_challenge$Main$main === 'undefined' ? null : _staltz$flux_challenge$Main$main);
